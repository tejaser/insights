...
class ReturnUsers extends Component {
  constructor(props) {
    super(props);
    this.state = {
      selectValue: 'Monday'
  ...
  render() {
    ...
    var brofin = !this.props.channel ? [{ bowserName: 'No-browser', userCount: 1 }] : this.props.channel;
    var brotop = brofin
      .sort(function(a, b) {
    ...
    return (
      <div className="container">
        ...
        <div className="row">
          <div className="col-4 mt-lg-0 mt-3  pr-2 pl-2 pl-lg-3">
            <div className="col-12 lxr-box-shadow py-3 p-0 h-100">
              ...
              <svg width={300} height={200}>
                ...
                />
                <VictoryLabel textAnchor="middle" style={{ fontSize: 20 }} x={100} y={100} text="# of users" />
                <VictoryLegend
                  standalone={false}
                  colorScale={['#ff6384', '#36a2eb']}
                  x={220}
        ...
        <div className="row mt-2">
          ...
          <div className="col-md-4 mt-lg-0 mt-3  pr-2 pl-2 pl-lg-3">
            <div className="col-12 lxr-box-shadow py-3 p-0 h-100">
              ...
              <div className="row">
                <h4 className="col-7 lxr-grey pl-4">Hour of Day</h4>
              ...
              <div className="col-12">
                <ul className="list-group list-group-flush">
                  {!this.props.topProduct ? (
                    ...
                    this.props.topProduct.map(function(data, index) {
                      return (
                        <li
                        ...
                        >
                          {data.productName}
                          <span className="badge badge-primary badge-pill">{`${Math.round(
                            data.count / prototal * 100
                          )}%`}</span>
                        </li>
                      );
                    })
          ...
          <p><i className="fa fa-desktop" aria-hidden="true"></i> &nbsp;Desktop Shares went up by 25% &uarr;</p> */}
            ...
            > */}
                ...
                <div className="col-4 border border-dark border-top-0 border-bottom-0">
                  ...
                  <p>Most popular product among Returning type of customers</p>
                </div>
                <div className="col-4">
                  <p>
                    <i className="fa fa-calendar-minus-o" aria-hidden="true" /> &nbsp;{!this.props.aggregatedInfo ? (
                      <i className="fa fa-spinner fa-pulse fa-1x fa-fw" />
                    ) : (
                      this.props.aggregatedInfo.desktopBuying
                    )}{' '}
                    chance of buying on a{' '}
                    <b style={{ color: 'black' }}>
                      {!this.props.aggregatedInfo ? (
                        <i className="fa fa-spinner fa-pulse fa-1x fa-fw" />
                      ) : (
                        this.props.aggregatedInfo.dektopWeekOfDay
                      )}
                    </b>{' '}
                    which is highest of all days of week
                  </p>
                  <p>
                    <i className="fa fa-clock-o" aria-hidden="true" /> &nbsp;Most likely to buy between
                    <b>8PM - 10PM</b>
                  </p>
                </div>
              </div>

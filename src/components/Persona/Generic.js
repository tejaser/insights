      ...
      <div className="container-fluid">
        ...
        <div className="row">
          ...
          <div className="col-md-4">
            ...
            <p className="pt-5"><i className="fa fa-bullseye" aria-hidden="true"></i>&nbsp; She <b>purchases</b> <b>{!this.props.aggregatedInfo ? <i className="fa fa-spinner fa-pulse fa-1x fa-fw"></i> : this.props.aggregatedInfo.avgItems} - {!this.props.aggregatedInfo ? <i></i> : this.props.aggregatedInfo.avgItems + 1}</b> items in an order.</p>
